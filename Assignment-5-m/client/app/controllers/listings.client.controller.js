angular.module('listings').controller('ListingsController', ['$scope', '$location', '$stateParams', '$state', 'Listings',
  function($scope, $location, $stateParams, $state, Listings){
    ...
    $scope.goToCreateListView = function() {
      $state.go('listings.create', { successMessage: 'Routed to Creation Page' });
    };
    ...
    $scope.goToEditView = function() {
      $state.go('listings.edit', { successMessage: 'Routed to Edit View' });
    };
    ...
    $scope.goToMapView = function() {
      $state.go('listings.maps', { successMessage: 'Map succesfully loaded!' });
    };
